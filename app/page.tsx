        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <div
                  className="bg-blue-50 rounded-2xl p-6 border-2 border-blue-200 animate-slide-in"
                  style={{ animationDelay: "0.2s" }}
                >
                  <h3 className="text-2xl font-semibold text-blue-700 mb-4">{slide.content.systemSummary.title}</h3>

                  <div className="space-y-4">
                    <div className="bg-white p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-700 mb-2">Cooling System</h4>
                      <div className="space-y-1 text-sm">
                        {Object.entries(slide.content.systemSummary.cooling).map(([key, value]) => (
                          <p key={key}>
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-700 mb-2">Heating System</h4>
                      <div className="space-y-1 text-sm">
                        {Object.entries(slide.content.systemSummary.heating).map(([key, value]) => (
                          <p key={key}>
                            <strong className="capitalize">{key}:</strong> {value as string}
                          </p>
                        ))}
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-700 mb-2">Airflow System</h4>
                      <div className="space-y-1 text-sm">
                        {Object.entries(slide.content.systemSummary.airflow).map(([key, value]) => (
                          <p key={key}>
                            <strong className="capitalize">{key}:</strong> {value as string}
                          </p>
                        ))}
                    ...
                    <div className="bg-white p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-700 mb-2">Controls & Features</h4>
                      <div className="space-y-1 text-sm">
                        {Object.entries(slide.content.systemSummary.controls).map(([key, value]) => (
                          <p key={key}>
                            <strong className="capitalize">{key}:</strong> {value as string}
                          </p>
                        ))}
                ...
                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8 border border-green-200">
                  <h3 className="text-2xl font-bold text-green-800 mb-6 flex items-center">
                    ...
                    {slide.content.conclusion.title}
                  </h3>

                  <div className="space-y-4">
                    <div className="text-lg font-semibold text-gray-800">{slide.content.conclusion.recommendation}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                      {slide.content.conclusion.benefits.map((benefit, index) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border-2 border-blue-200">
              <h3 className="text-xl font-bold text-blue-800 mb-4 flex items-center">
                <Calculator className="mr-2" />
                {slides[currentSlide].content.givenData.title}
              </h3>
              <div className="space-y-3">
                {slides[currentSlide].content.givenData.requirements.map((req, index) => (
                  <div key={index} className="flex justify-between items-center py-2 border-b border-blue-200">
                    <span className="text-sm font-medium text-gray-700">{req.label}:</span>
                    <span className="text-sm font-bold text-blue-700">{req.value}</span>
                  </div>
            ...
            <div className="bg-green-50 rounded-lg p-6 border-2 border-green-200">
              <h3 className="text-xl font-bold text-green-800 mb-4 flex items-center">
                <Zap className="mr-2" />
                {slides[currentSlide].content.finalResults.title}
              </h3>
              ...
              <div className="mb-4">
                ...
                <div className="text-sm space-y-1">
                  <div>
                    ...
                    {slides[currentSlide].content.finalResults.cooling.capacity}
                  </div>
                  <div>
                    <span className="font-medium">Sensible:</span>{" "}
                    {slides[currentSlide].content.finalResults.cooling.sensible}
                  </div>
                  <div>
                    <span className="font-medium">SHR:</span> {slides[currentSlide].content.finalResults.cooling.shr}
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="text-sm space-y-1">
                  <div>
                    ...
                    {slides[currentSlide].content.finalResults.heating.options}
                  </div>
                  <div>
                    <span className="font-medium">Selection:</span>{" "}
                    {slides[currentSlide].content.finalResults.heating.selection}
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="text-sm space-y-1">
                  <div>
                    ...
                    {slides[currentSlide].content.finalResults.airflow.supply}
                  </div>
                  <div>
                    <span className="font-medium">Exhaust:</span>{" "}
                    {slides[currentSlide].content.finalResults.airflow.exhaust}
                  </div>
                  <div>
                    <span className="font-medium">Motors:</span>{" "}
                    {slides[currentSlide].content.finalResults.airflow.motors}
                  </div>
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="text-sm space-y-1">
                  <div>
                    ...
                    {slides[currentSlide].content.finalResults.controls.features}
                  </div>
                  <div>
                    <span className="font-medium">Filtration:</span>{" "}
                    {slides[currentSlide].content.finalResults.controls.filtration}
                  </div>
                  <div>
                    <span className="font-medium">Electrical:</span>{" "}
                    {slides[currentSlide].content.finalResults.controls.electrical}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-gray-50 rounded-lg p-6 border-2 border-gray-200">
            ...
            <div className="text-lg font-semibold text-gray-800 mb-3">
              {slides[currentSlide].content.conclusion.recommendation}
            </div>
            <a
              href={slides[currentSlide].content.conclusion.link}
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:text-blue-800 underline text-sm mb-4 block"
            >
              {slides[currentSlide].content.conclusion.link}
            </a>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {slides[currentSlide].content.conclusion.achievements.map((achievement, index) => (
                <div key={index} className="flex items-center">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                  <span className="text-sm text-gray-700">{achievement}</span>
                </div>
